-- Migración: Reestructurar sistema de prestaciones (CORREGIDO)
-- Fecha: 2025-10-01
...
CREATE TABLE `prestaciones_pacientes` (
  ...
  `id_prestacion` bigint(20) UNSIGNED NOT NULL COMMENT 'Servicio del catálogo',
  `id_profesional` bigint(20) UNSIGNED NOT NULL COMMENT 'Profesional asignado',
  `id_empresa` bigint(20) UNSIGNED DEFAULT NULL COMMENT 'Empresa intermediaria (nullable si es independiente)',
...
-- Mantener solo: id, nombre_completo, dni, localidad, id_obra_social, estado, created_at, updated_at
