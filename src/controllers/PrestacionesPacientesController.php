...
class PrestacionesPacientesController
{
    ...
    public function store($idPaciente)
    {
        ...
        $data = [
            ...
            'horas_por_dia' => !empty($_POST['horas_por_dia']) ? number_format((float)$_POST['horas_por_dia'], 1, '.', '') : null,
            'horas_mes' => !empty($_POST['horas_mes']) ? number_format((float)$_POST['horas_mes'], 2, '.', '') : null,
            'horas_mes_override' => !empty($_POST['horas_mes_override']) ? 1 : 0,
