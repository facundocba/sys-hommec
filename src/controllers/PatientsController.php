        ...
        if ($patientId) {
            ...
            foreach ($_POST['prestaciones'] as $prestacion) {
                ...
                $prestacionData = [
                    ...
                    'horas_por_dia' => !empty($prestacion['horas_por_dia']) ? number_format((float)$prestacion['horas_por_dia'], 1, '.', '') : null,
                    'horas_mes' => !empty($prestacion['horas_mes']) ? number_format((float)$prestacion['horas_mes'], 2, '.', '') : null,
                    'horas_mes_override' => !empty($prestacion['horas_mes_override']) ? 1 : 0,
