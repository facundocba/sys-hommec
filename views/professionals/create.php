...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-header-text">
            <h1>Crear Nuevo Profesional</h1>
            <p>Complete el formulario para agregar un nuevo profesional al sistema</p>
        </div>
...
<div class="form-card">
    <form method="POST" action="<?= baseUrl('professionals/store') ?>">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            placeholder="Ej: Kinesiología, Psicología, Nutrición"
