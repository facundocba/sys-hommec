    ...
    <div class="page-header-content">
        <div class="page-header-left">
            ...
            <div class="page-header-text">
                ...
                <p>Gestione los profesionales de salud del sistema</p>
            </div>
        </div>
        <a href="<?= baseUrl('professionals/create') ?>" class="btn-new">
...
<div class="filters-card">
    <div class="filters-header">
        <div class="filters-header-content">
            ...
            <h3 class="filters-title">Filtrar Profesionales</h3>
        </div>
    </div>
    <div class="filters-body">
        <form method="GET" action="<?= baseUrl('professionals') ?>">
            <div class="filters-row">
                ...
                <div class="form-group">
                    ...
                    <select name="especialidad" class="form-control form-select">
                        <option value="">Todas</option>
                        <?php foreach ($especialidades as $esp): ?>
                            <option value="<?= htmlspecialchars($esp) ?>" <?= $filters['especialidad'] === $esp ? 'selected' : '' ?>>
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($professionals as $professional): ?>
                    <tr>
                        <td>
                            <strong class="company-name"><?= htmlspecialchars($professional['nombre']) ?></strong>
                        </td>
                        <td><?= htmlspecialchars($professional['especialidad'] ?? '-') ?></td>
                        <td><?= htmlspecialchars($professional['email'] ?? '-') ?></td>
                        <td><?= htmlspecialchars($professional['telefono'] ?? '-') ?></td>
                        <td>
                            <?php if ($professional['estado'] === 'activo'): ?>
                        ...
                        <td>
                            <div class="actions-cell">
                                <a href="<?= baseUrl('professionals/edit/' . $professional['id']) ?>"
                                ...
                                <?php if (getCurrentUser()['rol'] === 'administrador'): ?>
                                    <form method="POST"
                                          action="<?= baseUrl('professionals/delete/' . $professional['id']) ?>"
                                          style="display: inline;"
                                          onsubmit="return confirmDelete('¿Está seguro de desactivar este profesional?')">
