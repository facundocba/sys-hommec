...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p>Modifique la información del profesional en el sistema</p>
        </div>
        <a href="<?= baseUrl('professionals') ?>" class="btn-back">
...
<div class="form-card">
    <form method="POST" action="<?= baseUrl('professionals/update/' . $professional['id']) ?>">
        ...
        <div class="form-section">
            <div class="form-section-header">
                ...
                <h2 class="form-section-title">Información del Profesional</h2>
            </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['nombre'] ?? $professional['nombre']) ?>"
                            required
                            autofocus
                        >
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="especialidad"
                            name="especialidad"
                            class="form-control <?= isset($formErrors['especialidad']) ? 'is-invalid' : '' ?>"
                            value="<?= htmlspecialchars($formData['especialidad'] ?? $professional['especialidad'] ?? '') ?>"
                            required
                        >
                        <?php if (isset($formErrors['especialidad'])): ?>
                            <div class="invalid-feedback"><?= $formErrors['especialidad'] ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['telefono'] ?? $professional['telefono'] ?? '') ?>"
                        >
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['email'] ?? $professional['email'] ?? '') ?>"
                        >
                        <div class="form-hint">Opcional - Solo si el profesional tiene email corporativo</div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select id="estado" name="estado" class="form-control form-select" required>
                            <option value="activo" <?= ($formData['estado'] ?? $professional['estado']) === 'activo' ? 'selected' : '' ?>>
                                Activo
                            </option>
                            <option value="inactivo" <?= ($formData['estado'] ?? $professional['estado']) === 'inactivo' ? 'selected' : '' ?>>
                                Inactivo
                            </option>
                        </select>
                    </div>
            ...
            <div class="info-box">
                <div class="info-box-content">
                    <div class="info-box-item">
                        ...
                        <span class="info-box-label">Profesional creado:</span>
                        <span><?= formatDate($professional['fecha_creacion'], 'd/m/Y H:i') ?></span>
                    </div>
                    <div class="info-box-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span><?= formatDate($professional['fecha_modificacion'], 'd/m/Y H:i') ?></span>
                    </div>
                </div>
            </div>
        </div>
