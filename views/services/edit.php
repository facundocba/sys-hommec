...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p>Modifique la información de la prestación en el sistema</p>
        </div>
...
<div class="form-card">
    <form method="POST" action="<?= baseUrl('services/update/' . $service['id']) ?>">
                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['nombre'] ?? $service['nombre']) ?>"
                            required
                            autofocus
                        >
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['codigo'] ?? $service['codigo'] ?? '') ?>"
                        >
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <?php foreach ($tiposPrestacion as $tipo): ?>
                                <option
                                    value="<?= $tipo['id'] ?>"
                                    <?= ($formData['id_tipo_prestacion'] ?? $service['id_tipo_prestacion'] ?? '') == $tipo['id'] ? 'selected' : '' ?>
                                >
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            class="form-control"
                            rows="4"
                        ><?= htmlspecialchars($formData['descripcion'] ?? $service['descripcion'] ?? '') ?></textarea>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <select id="estado" name="estado" class="form-control form-select" required>
                            <option value="activo" <?= ($formData['estado'] ?? $service['estado']) === 'activo' ? 'selected' : '' ?>>
                                Activo
                            </option>
                            <option value="inactivo" <?= ($formData['estado'] ?? $service['estado']) === 'inactivo' ? 'selected' : '' ?>>
                                Inactivo
                            </option>
                        </select>
                    </div>
            ...
            <div class="info-box">
                <div class="info-box-content">
                    <div class="info-box-item">
                        ...
                        <span class="info-box-label">Prestación creada:</span>
                        <span><?= formatDate($service['fecha_creacion'], 'd/m/Y H:i') ?></span>
                    </div>
                    <div class="info-box-item">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span><?= formatDate($service['fecha_modificacion'], 'd/m/Y H:i') ?></span>
                    </div>
                </div>
            </div>
        </div>
