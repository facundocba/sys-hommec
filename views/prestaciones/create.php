...
<form method="POST" action="<?php echo baseUrl('prestaciones/store'); ?>">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="3"
                          placeholder="Descripción de la prestación..."><?php echo htmlspecialchars($formData['descripcion'] ?? ''); ?></textarea>
            </div>
