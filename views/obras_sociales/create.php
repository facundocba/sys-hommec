    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo baseUrl('obras-sociales/store'); ?>">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control"
                                                   id="sigla" name="sigla"
                                                   value="<?php echo htmlspecialchars($formData['sigla'] ?? ''); ?>"
                                                   placeholder="Ej: OSDE">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="observaciones" name="observaciones"
                                                      rows="3" placeholder="Información adicional sobre la obra social..."><?php echo htmlspecialchars($formData['observaciones'] ?? ''); ?></textarea>
                                        </div>
