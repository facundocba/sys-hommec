...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-header-text">
            ...
            <p>Complete el formulario para agregar una nueva obra social al sistema</p>
        </div>
...
<div class="form-card">
    <form method="POST" action="<?= baseUrl('obras-sociales/store') ?>">
                ...
                <div class="col-8">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            placeholder="Ingrese el nombre completo de la obra social"
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($formData['sigla'] ?? '') ?>"
                        >
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            placeholder="Información adicional sobre la obra social, notas internas, convenios especiales, etc."
                            rows="4"
