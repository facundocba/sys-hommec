    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="<?php echo baseUrl('tipos-prestacion/store'); ?>">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="descripcion" name="descripcion"
                                                      rows="3" placeholder="Descripción del tipo de prestación..."><?php echo htmlspecialchars($formData['descripcion'] ?? ''); ?></textarea>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="modo_frecuencia" name="modo_frecuencia">
                                                <option value="sesiones" <?php echo ($formData['modo_frecuencia'] ?? 'sesiones') === 'sesiones' ? 'selected' : ''; ?>>Sesiones por mes</option>
                                                <option value="horas" <?php echo ($formData['modo_frecuencia'] ?? '') === 'horas' ? 'selected' : ''; ?>>Horas por semana</option>
                                            </select>
